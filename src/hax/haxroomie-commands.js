...
room.onPlayerJoin = function(player) {
    room.sendChat("Welcome @"+pingPlayer(player.name)+" to the NFLCHL room! To see a list of commands, type '.help'.");
    updateAdmins();
...
room.onGameTick = function(){
    ...
    if (Number.isInteger(ticks/18000)){
        room.sendAnnouncement("Come join the NFLCHL Discord! https://discord.gg/ZfX9XXtb45", null, nflchlColor, "normal", 1)
    }
}
