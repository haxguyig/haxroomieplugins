...
const webhook = room.getConfig('webhookUrl')
...
room.onPlayerAdminChange = function(changedPlayer, byPlayer){
    ...
    if (admins.length === 1){
        ...
        room.sendChat("@"+pingPlayer(player.name)+" you can't remove your admin when you're the only admin in the room!")
    }
}
room.onPlayerJoin = function(player) {
    room.sendChat("Welcome "+player.name+" to the NFLCHL roomxds!");
    updateAdmins();
