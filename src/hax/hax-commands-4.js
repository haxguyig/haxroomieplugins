...
room.onPlayerJoin = function(player) {
    room.sendChat("Welcome @"+pingPlayer(player.name)+" to the HR room! To see a list of commands, type '.help'.");
    updateAdmins();
...
room.onTeamVictory = function(scores){
    ...
    if (scores.blue === 0){
        for (var key in redTeamPos){
            console.log(redTeamPos[key]+" "+key)
...
function sendAnnouncementToDiscord(message) {
    webhook = "https://discord.com/api/webhooks/871270071987765298/Rndt5Y2CA4IcOSa1uZLmuI-seMWF5dksPoFdTB6YxCA9oDBnnRH3EtlpB_7G7ji6ZOj5" //room.getConfig().webhookUrl;
...
//    var adminLogin = room.getConfig().adminLoginPasswords
    ...
    if (["afk"].includes(split_message)){
        ...
        room.sendChat("HR Discord Link: https://discord.gg/bDZ64dzuA9")
    }
        ...
        command_desc =
        {
            ...
            "discord": "Invites you to the HR discord! https://discord.gg/bDZ64dzuA9",
...
room.onGameTick = function(){
    ...
    if (Number.isInteger(ticks/18000)){
        room.sendAnnouncement("Come join the HR Discord! https://discord.gg/bDZ64dzuA9", null, nflchlColor, "normal", 1)
    }
}
