...
var room = HBInit({roomName: "mood",playerName:"Xd",noPlayer:false,public:false,maxPlayers:12});
...
var paused = false;
var ticks = 0;
var adminLogin = {"richana": "richy", "nfana": "Nfab", "namana": "Name", "claynflc": "Clay"}
...
room.onPlayerChat = function (player, message) {
    ...
    if (!(["setcode", "login"].includes(split_message))) console.log("??")
